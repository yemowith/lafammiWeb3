...
class App {
    constructor(configPath) {
        ...
        this.transactionManager = TransactionManager_1.default;
        this.eventListener = EventListener_1.default;
        this.initialize();
    }
    initialize() {
        ...
        // Varsayılan olarak ilk provider'ı aktif provider olarak ayarlayalım
